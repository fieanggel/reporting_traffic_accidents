// frontend/lib/api/report-service.ts
...
// ============================================================
// PERHATIAN: uploadFileToS3 SUDAH DIHAPUS!
// Upload gambar sekarang menggunakan:
// import { uploadToCloudinary } from "@/lib/cloudinary/upload-service"
// ============================================================

/**
 * Membuat laporan baru (Public)
 * image_url harus sudah didapat dari Cloudinary sebelum memanggil fungsi ini
 */
